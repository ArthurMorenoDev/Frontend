            ...
            <div className="bg-slate-400 border border-slate-600 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30 relative">
                ...
                <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                    <div className="relative my-4">
                        <input ref={emailRef} placeholder="" type="email" className="block w-72 py-2.5 px-0 text-sm text-black bg-transparent border-0 border-b-2 border-grey-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-dark focus:border-blue-600 peer" />
                    ...
                    <div className="relative z-0 w-full mb-6 group">
                        <input ref={passwordRef} placeholder="" type="password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-dark dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
